...
public class H2UserDAOTest {
    ...
    public void getUserByIdTest() throws Exception {
        UserEntity user = userDAO.getById(1).get();
        assertEquals(user.getUsername(), "ambush");
    }

    @Test
    public void getUserByUsernameTest() throws Exception {
        UserEntity user = userDAO.getByUsername("ambush").get();
    ...
    public void deleteUserByIdTest() throws Exception {
        ...
        Optional<UserEntity> userOptional = userDAO.getByUsername("ambush1");
    ...
    public void createUserTest() throws Exception {
        ...
        Optional<UserEntity> user1 = userDAO.getByUsername("insane-nna");
    ...
    public void updateUserTest() throws Exception {
        ...
        UserEntity user1 = userDAO.getByUsername("ambush").get();
